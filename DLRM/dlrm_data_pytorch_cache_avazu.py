...
class AvazuDataset_WithListIndexSupport(AvazuDataset):
...
class Data_Manager(object):
    ...
    def __init__(self, args) -> None:
        if args.mlperf_logging and args.memory_map and args.data_set == "terabyte":
            ...
            # Datasets
            self.train_data = AvazuDataset_WithListIndexSupport(
                args.data_set,
                args.max_ind_range,
                args.data_sub_sample_rate,
            ...
            self.test_data = AvazuDataset_WithListIndexSupport(
                args.data_set,
                args.max_ind_range,
                args.data_sub_sample_rate,
                None, #args.data_randomize,
            ...
            self.train_loader = torch.utils.data.DataLoader(
                ...
                collate_fn=self.collate_cached_wrapper_avazu,
                pin_memory=False,
