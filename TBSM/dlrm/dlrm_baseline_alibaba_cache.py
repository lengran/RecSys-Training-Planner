...
class DLRM_Net(nn.Module):
	...
	def forward(self, dense_x, lS_o, lS_i, j):
		return self.mixed_forward(dense_x, lS_o, lS_i, j)
	...
	def mixed_forward(self, dense_x, lS_o, lS_i, j):	
		...
		if self.parallel_model_is_not_prepared or j == 0:
		...
		torch.cuda.synchronize()
		end_emb_dist = time.time()
		
		#if should_print:
		# print("EMB_dist_cpu_gpu ", 1000*(end_emb_dist - begin_emb_dist))
